...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center relative p-4 overflow-hidden select-none">
      ...
      {/* Premium Loading Screen Overlay (กรุณารอสักครู่) */}
      {loading && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-md animate-fade-in select-none">
          <div className="bg-white/95 dark:bg-[#1a1a1a]/95 rounded-[32px] p-8 max-w-[320px] w-full text-center border border-white/20 dark:border-white/10 shadow-[0_25px_60px_rgba(0,0,0,0.25)] animate-zoom-in">
